    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-5xl px-4">
        <div className="rounded-2xl p-8 md:p-12 text-center" style={{ background: "var(--gradient-hero)" }}>
          ...
          <h2 className="mt-4 text-3xl md:text-4xl font-extrabold text-white">Ai nevoie de un electrician autorizat?</h2>
          <p className="mt-3 text-white/80 max-w-xl mx-auto">Estimare gratuită în maxim 15 minute. Fără deplasare facturată la urgențe în București.</p>
